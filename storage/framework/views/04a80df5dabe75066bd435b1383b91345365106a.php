 <!-- ***** Chefs Area Starts ***** -->
                ...
                <div class="col-lg-4">
                    <div class="chef-item">
                        <div class="thumb">
                            ...
                            <img height="500" width="200" src="chefimage/<?php echo e($data2->image); ?>" alt="Chef #1">
                        </div>
    ...
    <!-- ***** Chefs Area Ends ***** --><?php /**PATH C:\xampp\htdocs\Restaurant-master\resources\views/foodchef.blade.php ENDPATH**/ ?>