            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li class="scroll-to-section"><a href="<?php echo e(route('login')); ?>" class="active">Home</a></li>
...
<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 ...
 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
         ...
         <?php $__currentLoopData = $data2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr style="position: relative; top: -70px; left:360px;">

             <td>
                 <a class="btn btn-warning" href="<?php echo e(url('/remove',$data2->id)); ?>" >Remove</a>
             </td>
...
<tr>
       <td>
        <input class="btn btn-success" type="submit" value="Order Confirm" onclick="return confirm('your order is confirm')" ></td>

        <td><button id="close" type="button" class="btn btn-danger">Close</button></td>
...
</html><?php /**PATH C:\xampp\htdocs\Restaurant-master\resources\views/showcart.blade.php ENDPATH**/ ?>